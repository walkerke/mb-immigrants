...
tracts = "data-raw/nhgis0090_shape/US_tract_2016.shp"
...
def erase_and_clean(tract_id, block_id):
    ...
    blocks = "data/blocks10/nopop/" + block_id + "_nopop.shp"
    block_layer = mg.MakeFeatureLayer(blocks)
    # Run the Erase tool
    out_erase = "data/2016/erase/" + block_id + "_erase.shp"
    ...
    out_singlepart = "data/2016/singlepart/" + block_id + "_single.shp"
    ...
    out_dissolve = "data/2016/dissolve/" + block_id + "_dissolve.shp"
