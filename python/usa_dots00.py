...
mg.CreateFileGDB("data/2000/dissolve", "full.gdb")

gdb = "data/2000/dissolve/full.gdb"
...
arcpy.conversion.FeatureClassToFeatureClass("data/2000/dissolve/full_dissolved_2000.shp", gdb, "full_dasymetric")
...
for scale in scales: 
    ...
    out_name = "data/2000/immigration" + str(scale) + ".csv"
