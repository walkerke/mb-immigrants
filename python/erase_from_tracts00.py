...
tracts = "data-raw/nhgis0090_shape/US_tract_2000.shp"

tract_layer = mg.MakeFeatureLayer(tracts)
          
def erase_and_clean(tract_id, block_id):
    tract_clause = '"NHGISST" LIKE ' + "'" + tract_id + "%'"
    ...
    blocks = "data/blocks00/nopop/" + block_id + "_nopop.shp"
    block_layer = mg.MakeFeatureLayer(blocks)
    # Run the Erase tool
    out_erase = "data/2000/erase/" + block_id + "_erase.shp"
    ...
    out_singlepart = "data/2000/singlepart/" + block_id + "_single.shp"
    ...
    out_dissolve = "data/2000/dissolve/" + block_id + "_dissolve.shp"
